...
# 1. Inisialisasi API Key Pinecone (DIUBAH DEMI KEAMANAN GITHUB)
# Silakan masukkan API Key Anda kembali saat menjalankan kode ini secara lokal di laptop
PINECONE_API_KEY = "ISI_API_KEY_PINECONE_ANDA_DISINI"
...
articles = [
    ...
    {"id": "4", "title": "Latihan Fisik Kardio untuk Jantung", "desc": "Olahraga seperti lari pagi, berenang, and bersepeda sangat baik untuk menjaga kesehatan kardiovaskular dan stamina tubuh."},
